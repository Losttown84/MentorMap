...
class DatePickerSelector extends React.Component {
    ...
    renderDaysInMonth() {
        ...
        for (var i = 0; i < 7; i++) {
            ...
            row.push(<td onClick={this.clickDay} className={className} data-day={startDate.date()} data-month={startDate.month()}>{startDate.date()}</td>);
    ...
    render = () => {
        ...
        <div className={datePickerSelectorClassName}>
            ...
            <tr className="datePickerSelectorTableHeader">
                <td onClick={ this.clickPreviousMonth }><svg className="datePickerSelectorTableHeaderPreviousMonth svg-icon" viewBox="0 0 20 20">
                ...
                <td onClick={ this.clickNextMonth }><svg className="datePickerSelectorTableHeaderNextMonth svg-icon" viewBox="0 0 20 20">
    ...
    export {DatePicker, DatePicker1, DatePickerLabel, DatePickerSelector};
