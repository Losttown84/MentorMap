...
<nav className="navbar navbar-expand-xl navbar-light bg-light">
            ...
            <form className="needs-validation" novalidate>
                    <div className="form-row">
                        ...
                        <label for="validationCustom01">I am looking to learn</label>
                    ...
                    <div className="form-row">
                        ...
                        <label for="validationCustom03">Where would you like to meet? </label>
                        ...
                        <input type="text" className="form-control" id="validationCustom04" placeholder="Date" required></input>
                        <div className="invalid-feedback">
